...
uint256 hashGenesisBlock("0x0000000081ee304cf32cb9555745c04561b857e712c6bdf9f3ba1fbc6f92a871");
...
const string strMessageMagic = "xaucoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 2100 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 2100);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 21600;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000081ee304cf32cb9555745c04561b857e712c6bdf9f3ba1fbc6f92a871");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1425308341;
        block.nBits    = 486604799;
        block.nNonce   = 1271958010;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("xaucoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("xaucoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running xaucoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("xaucoinMiner terminated\n");
        throw;
    }
}
